...
- [[./src/simplexnoise.org][thi.ng.math.simplexnoise]]
...
|-----------+------------+------------------------------------------+-------------------------+---------------------|
|     0.2.0 | TBA        | add protocols, minor refactorings        | =[thi.ng/math "0.2.0"]= | [[https://github.com/thi-ng/math/tree/0.2.0][0.2.0]]               |
